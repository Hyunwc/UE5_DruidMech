...
void AItem::BeginPlay()
{
	...
	CollisionVolume->OnComponentBeginOverlap.AddDynamic(
		this, &AItem::OnOverlapBegin);
	CollisionVolume->OnComponentEndOverlap.AddDynamic(
		this, &AItem::OnOverlapEnd);
...
void AItem::Tick(float DeltaTime)
{
	...
	if (bRotate)
	{
		...
		Rotation.Yaw += DeltaTime * RotationRate; // 초당 45도로 회전
